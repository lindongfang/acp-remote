...
> 基线：2026-09-23（2026-09-24 随 `identity-auth-and-keystore` 补充切片 3 的落地状态，2026-09-25 随 `daemon-cli-and-local-admin` 补充切片 4 的落地状态）。实际能力以代码和测试为准；各项待实现内容以其权威文档为准。
