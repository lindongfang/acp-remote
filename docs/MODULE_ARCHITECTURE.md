...
管理表、Export/Import 与审计端口的落盘仍待实现，具体表设计、事务、v1 → v2 升级和验收见 [CORE_PORTS_AND_STORAGE.md](./CORE_PORTS_AND_STORAGE.md) §7.2/§7.3/§7.4 与 §11。管理数据保持同一 SQLite 文件与 owned/imported 家族边界，不新增 crate；配置来源权威见 [CONFIG_REFERENCE.md](./CONFIG_REFERENCE.md)。
