...
mod tests {
    ...
    fn digest_of(text: &str) -> Digest {
        ...
        Digest::new(&base64::engine::general_purpose::URL_SAFE_NO_PAD.encode(bytes))
            .expect("摘要文本")
    }
    ...
    fn snapshot_digest_is_the_sha256_of_the_ordered_chunk_digests() {
        ...
        let reordered =
            snapshot_digest(&[Sha256::digest(b"frame-two"), Sha256::digest(b"frame-one")])
                .expect("摘要");
        assert_ne!(
            base64url(digest.as_bytes()),
