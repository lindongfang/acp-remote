<!-- 承接 proposal 的能力清单与变更范围，定义可观察行为及验收场景。
     与并行编写的 design 共同收敛后，供 plan.md 映射工作包和验证范围；
     测试 Agent 据此细化用例，reviewer 和最终验收据此核对符合性与覆盖，归档时将增量同步到主规范。
     技术方案放入 design.md，协作与验证安排放入 plan.md，具体任务放入 tasks.md。 -->
