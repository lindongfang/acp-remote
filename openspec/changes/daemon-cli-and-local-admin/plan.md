...
| RV1 | 各 WP 交付前、主分支复核 | 独立 reviewer 按 `roles/reviewer.md` 在隔离上下文检视固定版本 diff 与契约 | 只读；不修改代码与证据 | 报告完整、无未解决阻断项；覆盖 specs 场景与 design 决策 | `openspec/changes/daemon-cli-and-local-admin/reports/rv1-wp1.md` … `rv1-wp5.md`、`rv2-wp4.md`、`rv2-wp5.md`、`rv3-candidate.md`、`rv4-candidate.md`（按轮次累积；原列的 `rv1-du1.md` 仅存在于已归档变更） |
